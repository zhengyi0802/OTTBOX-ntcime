...
public class KeyboardSwitch {
  ...
  private SoftKeyboard numberEnglishKeyboard;
  private SoftKeyboard numberZhuyinKeyboard;
  ...
  public void initializeKeyboard(int displayWidth) {
    ...
    numberEnglishKeyboard = new SoftKeyboard(context, R.xml.num_en);
    numberZhuyinKeyboard = new SoftKeyboard(context, R.xml.num_zhuyin);
